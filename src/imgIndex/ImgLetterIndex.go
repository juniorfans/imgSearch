...
/**
	此处是识别的关键
 */
func GetLetterIndexFor(letterConfig *config.LetterConfig,data [][][]uint8,dbId uint8, mainImgkey []byte) []SubImgIndex {
	...
	letterIndex[0].Init(dbId, mainImgkey,0,letterConfig.IndexLength,letterConfig.Id)
